namespace Connected.Customers.Authorization.Desks.Claims;
...
//	public override string EntityId => Dto. base.Instance.Id.ToString();
...
//		if (!await (await authentication.SelectIdentity()).HasClaim(claims, DeskClaims.DeskSecurity, Entity, EntityId))
